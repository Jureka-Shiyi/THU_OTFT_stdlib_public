#set driving
set cell_name MAC
set clk_period 3.0e7
set half_clk_period [expr {0.5*$clk_period}]
set max_clk_period [expr {0.001*$clk_period}]
set min_clk_period [expr {0.0000001*$clk_period}]
...
set_input_delay -max $max_clk_period -clock CLK [all_inputs]
set_input_delay -min $min_clk_period -clock CLK  [all_inputs]

set_output_delay -max $max_clk_period -clock CLK [all_outputs]
set_output_delay -min $min_clk_period -clock CLK [all_outputs]

set_max_delay $max_clk_period -from [all_inputs] -to [all_outputs]
set_min_delay $min_clk_period -from [all_inputs] -to [all_outputs]
...
#................DRC max_capacitance.............................
set_load [load_of OTFT_stdlib/INVD1/IN] [all_outputs]
