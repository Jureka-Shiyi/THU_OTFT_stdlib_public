...
create_route_type -name leaf_rule -top_preferred_layer M5 -bottom_preferred_layer M1
create_route_type -name trunk_rule -top_preferred_layer M5 -bottom_preferred_layer M1
...
setOptMode -usefulSkewCCOpt false
source cts.spec
ccopt_design    
