...
# ============================================================
# Horizontal stripes on M3 (与 M1 平行)
# ============================================================
addStripe \
  -nets { VSS VDD } \
  -layer M3 \
...
# ============================================================
# Vertical stripes on M4 (与 M2 平行)
# ============================================================
addStripe \
  -nets { VDD VSS } \
  -layer M4 \
...
# ============================================================
# Horizontal stripes on M5 (顶层主干，最宽)
# ============================================================
addStripe \
  -nets { VSS VDD } \
  -layer M5 \
...
sroute -connect { stripe } \
       -layerChangeRange { M1 M5 } \
       -crossoverViaLayerRange { M1 M5 }

# 3. 创建足够大的外部接口 Pin (假设需要 100um 的 Pad)
createPGPin VDD -net VDD -geom M5 180 1000 280 1600
createPGPin VSS -net VSS -geom M5 180 200 280 800
