...
## 
## Test setup_hbm__D__hl__CK__lh
set tempTest [ SBTest "setup_hbm__D__hl__CK__lh" ]
$tempTest setTargets { setup_hbm__D__hl__CK__lh }
...
$tempWT setStimulus                            {   CK   D    Q    QN    } {
                               "0"          {} {   0    1    1    0     }
                   "initial_delay"     { in1 } {   -    0    -    -     }
           "(initial_delay)+setup" { in2 out } {   1    -    0    1     }
