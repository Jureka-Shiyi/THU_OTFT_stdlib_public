# LTPS TFT Standard Cell Library
# 12-track standard cell
# NAND, NOR, INV, DFF; driving capability 1x, 2x, 4x, 8x, 16x
# 2024-12-6
...
#
    ...
    set_opc_process LTPS_TFT_stdlib {
        {.lib "/data/tangwj/Cadence/TIANMA_LTPS2021/PDK_TIANMA_LTPS2021/tianma_ltps_2021.l" ntft_mac}
        {.lib "/data/tangwj/Cadence/TIANMA_LTPS2021/PDK_TIANMA_LTPS2021/tianma_ltps_2021.l" ptft_mac}
    }

    add_opc_supplies LTPS_TFT_stdlib VDD 10.0
    add_opc_grounds LTPS_TFT_stdlib VSS 0.0
    set_opc_temperature LTPS_TFT_stdlib 25

    set default_operating_conditions LTPS_TFT_stdlib
#
...
#    set smallest_load 1e-15
#    set largest_load 3.442e-13

    # Operating slew ranges
    set smallest_slew 10e-12
    set largest_slew 1.2e-8
    set default_slew 15e-12
    set explicit_points_slew {0.1e-9 0.2e-9 0.3e-9 0.4e-9 0.5e-9 0.7e-9 1.0e-9}
